...
4. What do we need in order to have a _many to many_ relationship between two tables?
  ...
  An intermediary table. This allows us to combine foreign keys from two different tables. It doesn't require a primary key, but the combination of the two foreign keys from the different files will be unique.